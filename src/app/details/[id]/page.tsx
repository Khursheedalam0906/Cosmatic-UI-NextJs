    ...
    <div className="pt-8">
      <div className="bg-gray-100 py-4">
        <div className="container flex gap-4 items-center text-gray-500">
          <Link href="/" className="curser-pointer hover:text-accent">
            Home
          </Link>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-[14px]">
              ...
              quos quod, optio nemo voluptas maxime perspiciatis. Est dolore rem
              accusamus!
            </p>
            <p className="text-gray-500 text-[14px]">20 in stock</p>
            <button className="uppercase bg-accent py-4 px-8 rounded-lg text-white flex gap-2 items-center hover:bg-black duration-500">
