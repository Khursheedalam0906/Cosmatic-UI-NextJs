...
const Hero = () => {
  return (
    <div className="container relative pt-5 sm:pt-10">
      <Image
      ...
      />
      <div
        className="hidden sm:block absolute top-[25%] left-[50%] translate-x-[-50%] translate-y[-50%] bg-white w-[250px]
      h-[200px] space-y-3 lg:w-[300px] lg:h-[270px] lg:space-y-6 xl:w-[400px] xl:h-[300px] p-6 xl:space-y-8"
      >
